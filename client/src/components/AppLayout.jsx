...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <aside className="fixed inset-y-0 left-0 hidden w-72 flex-col border-r border-slate-200 bg-white px-5 py-6 md:flex">
        <div className="flex items-center gap-3">
          <div className="rounded-2xl bg-indigo-600 p-3 text-white">
            <Sparkles size={20} />
          </div>
          <div>
            <h1 className="text-lg font-semibold text-slate-900">Study Planner AI</h1>
      ...
      <div className="md:pl-72">
        <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/90 backdrop-blur">
          ...
          <div className="flex gap-2 border-t border-slate-200 bg-white px-4 py-3 md:hidden">
            <NavLink
              to="/dashboard"
              className={({ isActive }) =>
                [
                  "flex-1 rounded-2xl px-4 py-3 text-center text-sm font-medium",
